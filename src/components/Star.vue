...
<div class="star-container">
  <svg
    ...
    x="0px" y="0px" width="46.354px" height="46.354px" viewBox="0 0 46.354 46.354"
    style="enable-background:new 0 0 46.354 46.354;" xml:space="preserve"
  >
    <g>
      <path fill="none" stroke="#000" d="M21.57,2.049c0.303-0.612,0.927-1,1.609-1c0.682,0,1.307,0.388,1.609,1l5.771,11.695c0.261,0.529,0.767,0.896,1.352,0.981
